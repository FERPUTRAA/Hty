...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Landroid/os/Bundle;)V
    ...
    const-string/jumbo v0, "sasCdMemtpeSaioios"
    ...
    const-string v1, " ogm nttoecb hdaCu retteigrsqf i d/ndeuiin/naut n nlo ecvmievu xtsie rdtee.ene"

    const-string v1, "i.snet rtgiceseuet enmifvgea/C uebot on/ nd cnhtitvardin ind  uteloiee qr dxue"

    const/4 v3, 0x3

    const-string/jumbo v1, "tc toaCcqtnvniidnoiomea ento dtgirrerdu  e/srb.fn etuieutd/ige eei eu h nen vx"
    ...
    const-string v0, "DOn.db_.ieitrcotAoTIEB.mtTniNnUaan"

    const-string/jumbo v0, "nncmtNOooUtaTtDdB_TEA.ne.daiin.Iri"

    const/4 v3, 0x3

    const-string v0, "OnnToNu.MrEnAaitUI_Tii.aBdDc.onetd"
    ...
    const-string/jumbo p2, "uttseoupl a tn t opong lerym "

    const-string p2, "gnt otltpaoy tel mursomne  u "

    const/4 v3, 0x0

    const-string p2, " t  mnugqtr sltema ynboo teup"
    ...
    const-string/jumbo p2, "nusol btns te tmluob cex"

    const-string/jumbo p2, "tnnuxb mclt oeentlbo u s"

    const/4 v3, 0x7

    const-string/jumbo p2, "o lmlstcbuu  tentntm nex"
...
.method public static ensureClassLoader(Landroid/os/Bundle;)V
    ...
    const-string/jumbo v1, "~f@@o@o-@  @~t~S o s o i@b Milonc ~~ doa~@~/@~o@/y~~rK~ui@fm  ~~~  b@~.@4t~@@@ ~ ~~@@l1v@@b@~~~ "
...
.method static getStateWithUpdatedPosition(Landroid/support/v4/media/session/PlaybackStateCompat;Landroid/support/v4/media/MediaMetadataCompat;)Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    const-string/jumbo v6, "nuieTba.UdrNdmadRottdiDea..AaIa"

    const-string/jumbo v6, "oIiaOaueitTdm.AUaD.dntNReaadrd."
...
.method public addOnActiveChangeListener(Landroid/support/v4/media/session/MediaSessionCompat$OnActiveChangeListener;)V
    ...
    const-string v0, "ele mnusL brantyilontu  "
...
.method public removeOnActiveChangeListener(Landroid/support/v4/media/session/MediaSessionCompat$OnActiveChangeListener;)V
    ...
    const-string/jumbo v0, "tseuae pnmi ern blytlpn "

    const-string v0, "e nsa rpmiyntel tbL elnu"

    const/4 v2, 0x6

    const-string v0, "eo yilmrqut ten  nselLna"
...
.method public sendSessionEvent(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    const-string p2, " nsno rot mteencquybetnal vl "

    const-string p2, "  bele oqoey uttmlrcennt nvna"

    const/4 v2, 0x6

    const-string/jumbo p2, "tyemnpol cbteoe eun mtn vnla "
...
.method public setPlaybackToRemote(Landroidx/media/u;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImpl;->setPlaybackToRemote(Landroidx/media/u;)V
    ...
    const-string v0, "ePlbonrvovlo!oema  lius  emrynd"

    const-string/jumbo v0, "ors!vr ealno luo eli emvmdbnPuy"

    const/4 v2, 0x3

    const-string v0, "eltdvbvbilour e ymn aer omu!Pln"
