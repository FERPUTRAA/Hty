...
.method public static toKeyCode(J)I
    ...
    const-string v2, "@ sb  @b@ ~@@~i~ld~~@c ~ m~ o@-@y ~@@n@ ~o~t M@. @o~b 1oS ~@u~4oor@fl/tai ~K @~~~s@v~~@@f ~/ ~i~"
...
.method public toString()Ljava/lang/String;
    ...
    const-string v1, "bast{yPaStekla "
    ...
    const-string/jumbo v1, "mn,mt o=sip"

    const-string/jumbo v1, "on=mtipis ,"

    const/4 v4, 0x7

    const-string/jumbo v1, "tonpo,=is i"
    ...
    const-string/jumbo v1, "on,fdbtfsioeurpboie "

    const-string v1, "fbnioerdfi eus, otop"

    const/4 v4, 0x2

    const-string/jumbo v1, "ir bfiu=ef ose,notpd"
    ...
    const-string v1, ",epbse=p"

    const-string/jumbo v1, "pede=bs,"

    const/4 v4, 0x6

    const-string/jumbo v1, "qdspe e,"
    ...
    const-string/jumbo v1, "pdsutue=d "

    const-string v1, "ep= d,uudt"

    const/4 v4, 0x7

    const-string v1, "au md=d,et"
    ...
    const-string/jumbo v1, "ot,aonics "

    const-string/jumbo v1, "n ao,tipcs"

    const/4 v4, 0x0

    const-string/jumbo v1, "inas,b=tco"
    ...
    const-string/jumbo v1, "orreq u=droc,"

    const-string/jumbo v1, "ro= ecorq,erd"

    const-string/jumbo v1, "odrc, epr reo"
    ...
    const-string v1, ",rrmssroqe= ege "

    const-string/jumbo v1, "rrss seego=m r,e"

    const/4 v4, 0x4

    const-string/jumbo v1, "sssemrao,=e egrr"
    ...
    const-string/jumbo v1, "im,mmnatso =ocsut"

    const-string/jumbo v1, "stcmum, n=tooicsa"

    const/4 v4, 0x5

    const-string/jumbo v1, "o= aot,css umnotc"
    ...
    const-string v1, " vdtmbi,e= aite i"
