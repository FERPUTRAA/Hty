...
.method public constructor <init>()V
    ...
    const-string v0, "dnsMroasenIdivedosiussiso.4dsatepo.ii.s.Srpmea"

    const-string v0, "MosiIsnipoi.ea.avdeeorr.ipusd.4tms.ssaedSdnsio"

    const/4 v2, 0x4

    const-string v0, ".oimuSapovdsd.sorreiai.isIdtospeaMe..innsm4sde"
...
.method public static asInterface(Landroid/os/IBinder;)Landroid/support/v4/media/session/IMediaSession;
    ...
    const-string v2, " f~@o@ ~M@ ~ ~@~  ct~@ ~l y u~Ksa~S.br~oob~@~i @@~~@4~lno -~ @~~@@~@/oiv@ ob1i@~ @~@f@@mod@  t~/"
    ...
    const-string v0, "a.iteb4ouramansedMd..eiooidrssepvsosn.nsipmd.i"

    const-string/jumbo v0, "oimmaannpsoi4odi.ddss...Mern.sSeosisdaeutrvepi"

    const/4 v3, 0x2

    const-string/jumbo v0, "iMSsoeu..vossiemsipspsentad4nI.oidde.uio.ranar"
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    const-string/jumbo v2, "oSsoai.p.pi.dnIdespiesssai4tnruedr.ovsoiMdn.mo"

    const-string v2, "dsosoievidisnnMe..oaeoiaSsp.tmrsd.e.i4norpIusd"

    const/4 v5, 0x5

    const-string/jumbo v2, "io.dp4sdqseessitanr.IvMnim.npiooeous..sediaSad"
