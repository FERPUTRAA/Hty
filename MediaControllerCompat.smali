...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    const-string/jumbo p2, "s s ln ekTuotuoessnsmln nibeo"

    const-string/jumbo p2, "o sn seeutousetinTnln  lksbom"

    const/4 v3, 0x5

    const-string/jumbo p2, "l smnet uilmonbu oseTn stkneo"
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat;)V
    ...
    const-string/jumbo p2, "lmCtopeoretmaMalCnori"

    const-string/jumbo p2, "mremtMCooCtllpaianero"
    ...
    const-string v0, "IMmdcbtaF oladeiereleaC iolorretlpn t"

    const-string v0, "elrioFdceonal pletotaMCraiodmtelre  I"
    ...
    const-string/jumbo p2, "lenoususstibb le nmnot u"

    const-string/jumbo p2, "leis boemsbuntulots snn "

    const/4 v3, 0x2

    const-string/jumbo p2, "usen tspel nnbolsismu ot"
...
.method public static getMediaController(Landroid/app/Activity;)Landroid/support/v4/media/session/MediaControllerCompat;
    ...
    const-string v3, "@ol@ 4y/q~~~@d abot~tso/c~ @@@~  .@~rS~~l@i~@  ~1 i M@@@fofKmv@~@~o nb~@~~ob~~~i@@@ ~    u ~@@ ~"
    ...
    const-string/jumbo v0, "uespmCoartnloiaeMlCrd"

    const-string v0, "aptomeunCtColairMrled"

    const/4 v4, 0x5

    const-string/jumbo v0, "rMmmnlptoadeaeCtooClr"
    ...
    const-string v2, "dtneoDodcablo jareg orietlCnte .Me"

    const-string v2, "de bttgpn.eerConijto erceaDMllaod "

    const-string v2, "aoidrbrtaeo DiCl.t deg olcbenjMeet"
...
.method static validateCustomAction(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    const-string v0, ".dWmpnuo.Led.tancsspqr.ovs.dOenosiir4a.iFitaOu"

    const-string v0, ".Weoaiuoq4ssmOpLorarsdo.natsO.ddi.piec.itnvFn."

    const/4 v3, 0x2

    const-string v0, "FOaL.Lopamdaosonsvisdu.noi.4p.n..istWdtrcreiOp"
    ...
    const-string v0, "da.o.LtsqvOaUim4iedn.L.Fneodocnsppastos.rir.NiWO"

    const-string v0, ".psUtvnNsooiei.Wspan.i..o.daeLiFdatrdnOco4sLmrOu"
    ...
    const-string v0, "aiUm4Iddooe_.eMEadETB..TsTUT.pGmsNsnRREnir_AsviID.AAMruop"

    const/4 v3, 0x4

    const-string/jumbo v0, "irsr..AouEaT4U.mRIBIs.TA.ooERNnUTiMpG_e_adsAdDpdEesMsvTtn"
    ...
    const-string/jumbo v1, "otsmxhdEI.Ri  i.edepon UearTMi iAerI4ruU .Deas_snotnrAfR_.d eNssvaiTq mo.dtpoolafiMiAtciEsrBTTEn GurA"

    const-string v1, "Didpot.rMmraAI4Ac eR  IoqasronBi_. xsTtsdai_eieMfoi.e.upvarAdNUlnsUEdT nti GRfitoTdAuriEsrsTno eE e.h"
...
.method public dispatchMediaButtonEvent(Landroid/view/KeyEvent;)Z
    ...
    const-string/jumbo v0, "v tuotllbyEnK a mb eeeno"

    const-string v0, "ane  bn te enlytlouvEKmb"

    const/4 v2, 0x2

    const-string v0, "Koe ebue nEll  ynyavbtnm"
...
.method public registerCallback(Landroid/support/v4/media/session/MediaControllerCompat$Callback;Landroid/os/Handler;)V
    ...
    const-string/jumbo p2, "sboanlu lclu mantckeu tub"

    const-string p2, "asmcbcunneutbtal oluk   l"

    const/4 v2, 0x3

    const-string/jumbo p2, "ls lmaoptcaktnlb n eblucu"
...
.method public sendCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
    ...
    const-string/jumbo p2, "uansltrmqubmr co pleeothtpneed m m ny "

    const-string/jumbo p2, "oe p eap rmlyenehtuonts nlbu m mnmcrdt"

    const/4 v2, 0x3

    const-string p2, "besr slmropeny  ntinmce adue thuonmtm "
...
.method public unregisterCallback(Landroid/support/v4/media/session/MediaControllerCompat$Callback;)V
    ...
    const-string v0, "albmn c unoqlekb asttml u"

    const-string/jumbo v0, "ob clmlnqual tsbalnke  tu"

    const/4 v3, 0x6

    const-string/jumbo v0, "uk  o cmnlttsbnacl uleoba"
